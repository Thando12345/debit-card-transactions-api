<x-app-layout>
    ...
    <header class="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12 shadow-lg">
        <div class="container mx-auto px-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold">Your Debit Cards</h1>
                    <p class="mt-2 text-lg opacity-90">Manage your debit cards and transactions securely</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ route('debit-cards.create') }}" 
                class="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg flex items-center gap-2 transition-all">
